...
The 14 node kinds in `@rimekit/core` v2.0. For the canonical Zod schemas see [`packages/core/src/schema.ts`](packages/core/src/schema.ts); the proposal at [`proposals/v2/dag-grammar.md`](proposals/v2/dag-grammar.md) has more design rationale.
