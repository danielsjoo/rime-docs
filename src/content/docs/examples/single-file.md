...
No script nodes, no Python / R interpreters required, no `report.yaml`. This is the smallest amount of Rime that does something interesting — useful for verifying your install or as the seed of a larger pipeline you grow into.
