...
For the CLI-equivalent semantics, see [ENV_MANAGEMENT.md in the repo](https://github.com/rimekit/rime/blob/main/ENV_MANAGEMENT.md) and [Polyglot runtime](/concepts/polyglot/).
